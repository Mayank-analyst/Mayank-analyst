...
Hi, I'm Mayank — a passionate Data Analyst in the making who enjoys turning raw data into actionable insights 📊

🎓 BSc Computer Science student
🧠 Skilled in Python, SQL, Excel & Power BI
🔍 Strong interest in data cleaning, analysis & visualization
...
→ Analyzed transaction data to identify failure patterns
→ Used Python (Pandas, NumPy) for data cleaning & EDA
→ Discovered key factors affecting transaction success rates
🛒 Walmart Sales Data Analysis
→ Explored sales trends and customer purchasing behavior
→ Used SQL & Power BI for insights and dashboard creation
→ Generated business insights to improve sales strategy
...
![](https://streak-stats.demolab.com/?user=Mayank-analyst&theme=dark)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=Mayank-analyst&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact)
